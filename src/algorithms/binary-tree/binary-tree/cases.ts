...
export const testBinaryTreeCase6 = async (proxy: { tree: BinaryTree<number> }) => {
  ...
  await wait(time2);
  const node1 = proxy.tree.getNodeByKey(1);
  ...
  await wait(time2);
  const node5 = proxy.tree.getNodeByKey(5);
  ...
  await wait(time2);
  const node9 = proxy.tree.getNodeByKey(9);
  ...
  console.log(getNodeByKey === undefined, 'getNode, 10, key'); // undefined

  await wait(time2);
  const node3 = proxy.tree.getNodeByKey(3);
  let subTreeSum = 0;
  node3 && proxy.tree.subTreeTraverse(node => (subTreeSum += node?.value ?? 0), node3);
  console.log(subTreeSum === 16, 'subTreeSum, 3'); // 16

  await wait(time3);
  const dfsNodes = proxy.tree.dfs(node => node, 'in');
  console.log(
    dfsNodes[0].key === 4 &&
    dfsNodes[1].key === 8 &&
    dfsNodes[2].key === 2 &&
  ...
  await wait(time1);
  const dfsInKeys = proxy.tree.dfs(node => node.key, 'in');
  console.log(
    dfsInKeys[0] === 4 &&
    dfsInKeys[1] === 8 &&
    dfsInKeys[2] === 2 &&
  ...
  await wait(time3);
  const dfsPreNodes = proxy.tree.dfs(node => node, 'pre');
  console.log(
    dfsPreNodes[0].key === 1 &&
    dfsPreNodes[1].key === 2 &&
    dfsPreNodes[2].key === 4 &&
  ...
  await wait(time1);
  const dfsItePreKeys = proxy.tree.dfs(node => node.key, 'pre');
  console.log(
    dfsItePreKeys[0] === 1 &&
    dfsItePreKeys[1] === 2 &&
    dfsItePreKeys[2] === 4 &&
  ...
  await wait(time1);
  const levelIteNodes: BinaryTreeNode[] = proxy.tree.bfs(node => node);
  console.log(
  ...
  await wait(time1);
  const lvIteKeys = proxy.tree.bfs(node => node.key);
  console.log(
    lvIteKeys[0] === 1 &&
    lvIteKeys[1] === 2 &&
    lvIteKeys[2] === 3 &&
  ...
  await wait(time1);
  const lvIteVals = proxy.tree.bfs(node => node.value);
  console.log(
    lvIteVals[0] === 1 &&
    lvIteVals[1] === 2 &&
    lvIteVals[2] === 3 &&
  ...
  await wait(time1);
  const lvNodes: BinaryTreeNode[][] = proxy.tree.listLevels(node => node);
  console.log(
  ...
  await wait(time1);
  const mPreKeys = proxy.tree.morris(node => node.key, 'pre');
  console.log(
    mPreKeys[0] === 1 &&
    mPreKeys[1] === 2 &&
    mPreKeys[2] === 4 &&
  ...
  await wait(time1);
  const mPostKeys = proxy.tree.morris(node => node.key, 'post');
  console.log(
    mPostKeys[0] === 8 &&
    mPostKeys[1] === 4 &&
    mPostKeys[2] === 9 &&
  ...
  await wait(time3);
  const dfsPostNodes = proxy.tree.dfs(node => node, 'post');
  console.log(
  ...
  await wait(time1);
  const dfsItePNodes = proxy.tree.dfs(node => node, 'post');
  console.log(
  ...
  const bfsValues = proxy.tree.bfs(node => node.value);
  console.log(
    bfsValues[0] === 1 &&
    bfsValues[1] === 2 &&
    bfsValues[2] === 3 &&
  ...
  await wait(time1);
  const bfsNodes = proxy.tree.bfs(node => node);
  console.log(
    bfsNodes[0].key === 1 &&
    bfsNodes[1].key === 2 &&
    bfsNodes[2].key === 3 &&
